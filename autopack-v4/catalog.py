...
IMPLEMENTED: dict[str, tuple[tuple[str, ...], tuple[str, ...]]] = {
    ...
    "AP-104": (("package-msi.ps1", ".github/workflows/autopack-v4.yml"), ("tests/test_package_msi.ps1", "tests/test_msi_lifecycle.ps1")),
    "AP-105": (("package-msi.ps1",), ("tests/test_package_msi.ps1", "tests/test_msi_lifecycle.ps1")),
